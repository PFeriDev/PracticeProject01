  ...
  return (
    <>
      <section
        ...
        <video
          className="absolute top-0 left-0 w-full h-[90%] object-cover opacity-30"
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="grid grid-cols-1 gap-3 z-10 relative">
          <h1 className="font-Poppins font-semibold text-center text-maingraybg text-5xl textshadow">
            Creative Web Development <br /> with the Latest Technologies!
          </h1>
          <h2 className="font-Poppins font-semibold text-center text-maingraybg text-3xl textshadow">
