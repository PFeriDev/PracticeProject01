            ...
            <div className="w-full h-[15rem]">
              ...
              <div>
                ...
                <p className="font-Inter font-normal text-lg text-maingraytext mt-2 mb-2">
                  Becoming a web developer wasn't a straight path, but every step I took contributed to me eventually
                  finding my place in this amazing and dynamic industry. Although I've always been interested in
              ...
              <p className="font-Inter font-normal text-lg text-maingraytext mt-2 leading-relaxed">
                As a child, I loved computers and everything digital. However, I wasn't sure what to do with this
                ...
                That was the moment I realized that web development wasn’t just interesting, but a real possibility for
                me. <br />
                <br /> The First Steps in Learning <br />
                Since I didn’t have formal education in programming, I decided to start learning through online
                ...
                application. During this development process, I didn’t just write code, but learned to approach
                ...
                moving at a slow pace. But I didn’t let that stop me. Throughout this process, I encountered many
                challenges, but every solved issue made me feel closer to what I wanted to achieve. The most important
                lesson I learned was that persistence and determination are key to progress. Even if things didn’t go as
                fast as I wanted, I knew that continuing was the key to success. Gradually, I got deeper into
                development, and at the end of the day, even if the code wasn’t perfect, I was satisfied with the
                ...
                Web development is not just a job for me; it's a passion. The ability to create something that is useful
                ...
                wider scale. As a web developer, many challenges still lie ahead, and that's what truly motivates me!
              </p>
